public class BattleScene {
    ...
    private Boolean makeHit(Character defender, Character attacker, Realm.FightCallback fightCallback) {
        ...
        if (defenderHealth <= 0 && defender instanceof Hero) {
            ...
            System.out.println(String.format("Враг повержен! Вы получаете %d опыт и %d золота", defender.getExperiencePoints(), defender.getGold()));
            attacker.setXp(attacker.getExperiencePoints() + defender.getExperiencePoints());
